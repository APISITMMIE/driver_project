...
$sql = "SELECT * FROM dv_tasks WHERE driver_name LIKE '%$driverFilter%' $dateCondition ORDER BY start_date DESC LIMIT $offset, $items_per_page";
...
if (isset($_GET['export'])) {
    ...
    $exportSql = "SELECT * FROM dv_tasks WHERE driver_name LIKE '%$driverFilter%' $dateCondition ORDER BY start_date DESC";
    ...
    if ($exportResult->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $holidayText . "</td>";
            echo "<td>" . $overtime1 . "</td>";
            echo "<td>" . $overtime3 . "</td>";
            echo "</tr>";
        }
        ...
        <table>
            ...
            <tbody>
                ...
                if(empty($driverFilter)) {
                    echo "<tr><td colspan='12' style= 'font-size: 20px;'>กรุณาเลือกคนขับรถเพื่อดูข้อมูล</td></tr>";
                }else {
